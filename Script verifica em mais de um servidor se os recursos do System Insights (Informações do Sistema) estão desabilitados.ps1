## Script verifica em mais de um servidor se os recursos do System Insights (Informações do Sistema) estão desabilitados - Créditos Gabriel Luiz - www.gabrielluiz.com ##
...
# Esse script apresenta todas as informações dos recursos desabilitados de dois servidores de uma só vez, demostrando o status, horário de agendamento e recurso do System Insights (Informações do Sistema).
